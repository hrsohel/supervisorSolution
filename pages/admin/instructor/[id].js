...
const editInstructor = ({data}) => {
    ...
    const [insImage, setInsImage] = useState(data.message[0].insImage)
    ...
    const submit = async (e) => {
        ...
        formData.append('insImage', insImage)
        formData.append('gender', gender)
        formData.append('department', department)
        formData.append('phone', phone)
        formData.append('newImage', newImage)
        const result = await axios.post(`/api/instructor/${data.message[0].iid}`, formData, {
                ...
                <div className='instructor w-full md:h-[84vh] overflow-auto'>
                    ...
                    <form className='w-full p-4' action="">
                        ...
                        <div className='relative w-[15rem] h-[15rem] rounded-full mx-auto'>
                            <img src={`/uploads/instructor/${data.message[0].insImage}`} 
...
export async function getServerSideProps(context) {
    ...
    const res = await fetch(`https://supervisorsolutions.com/api/instructor/${params.id}`)
