...
const login = () => {
    ...
    const submit = async e => {
        ...
        if(data.status === 200) history.reload("/coursesPages")
                        ...
                        <div className="lg:card lg:w-2/4 h-full bg-[#e2f5ff] shadow-xl pb-20">
                            ...
                            <div className='lg:px-0 px-2 '>
                                ...
                                <div className='mt-12 flex justify-center'>
                                    <button onClick={submit} className="btn btn-sm hover:text-red-600 bg-[#1F497B] border-none  drop-shadow-lg  text-white">Login</button>
                                </div>
                                <button className='hover:text-red-600 hover:bg-transparent transition duration-100 w-[10rem] bg-[#1F497B] text-white py-2 rounded-sm my-2 block mx-auto'>
                                    <Link href={`/companyLogin`}>Login as company</Link>
                                </button>
